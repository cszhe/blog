...
既然它这么想返回tuple, 那就按照tuple的逻辑来调用, 奇葩的是第二行代码, 其实是Github Copiolt给自动加的. chatGPT消一行给1分, 但是另一个GPT4加持的AI却觉得消一行得给10分. 我也懒得改了, 就这样吧.

## 总结


最后, Copiolt你是懂你的同类ChatGPT的, 我在写的时候, 它把GPT生成的代码的毛病都给找出来了. 如图所示:

![V4](/uploads/2023/copilot.png)
